...
vim.g.colors_name = 'jeff-default'
...
hi('CocPumMenu',     { link = 'Pmenu' })
hi('CocFloating',     { link = 'Pmenu' })
hi('CocMenuSel',     { link = 'PmenuSel' })
hi('CocPumVirtualText', { link = 'Comment' })
...
if vim.o.background == 'light' then
  ...
  hi('ColorColumn',  { bg = 'Grey',                            ctermbg = 'LightRed' })
  hi('CursorColumn', { bg = 'Blue', bg = 'Grey90',                 ctermfg = 'Blue', ctermbg = 'LightGrey' })
  hi('CursorLine',   { fg = 'Green', bg = 'Black',                 cterm = { underline = true } })
  ...
  hi('Search',       { bg = 'Grey',                                ctermbg = 'Grey' })
